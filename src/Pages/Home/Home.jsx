                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-7 md:px-3 gap-9">
                    ...
                    <div className="card bg-base-100 shadow-2xl">
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-start items-center gap-3">
                                <div className="h-10 w-10 ">
                                    <img className="h-full w-full rounded-full" src="/avatar2.png" alt="" />
                                </div>
                                <div>
                    ...
                    <div className="card bg-base-100 shadow-2xl">
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-start items-center gap-3">
                                <div className="h-10 w-10 ">
                                    <img className="h-full w-full rounded-full" src="/avatar3.png" alt="" />
                                </div>
                                <div>
